...
2. Write tests → tests/odyssey/fixtures/ (fixtures, generators)
3. Implement model → (direct Mojo implementation)
4. Benchmark performance → src/odyssey/benchmarking/
...
- `unit-tests.yml` - Leverages tests/odyssey/fixtures/
- `benchmark.yml` - Uses src/odyssey/benchmarking/
...
- [`run_tests`](../skills/tier-1/run-tests/SKILL.md)
  → Uses `tests/odyssey/fixtures/` for test execution
```text
...
├── Generate test data → tests/odyssey/fixtures/data_generators.mojo
├── Create test fixtures → src/odyssey/testing/test_models.mojo
├── Measure performance → src/odyssey/benchmarking/
