...
```mojo
# Before: confusing
from odyssey.utils.io import read_file  # Which io?

# After: clear
from odyssey.utils.file_io import read_file
```
...
from odyssey.core.extensor import ExTensor
...
### Exclude src/odyssey/ from Direct Build
...
from odyssey.utils.random import randn, uniform
...
- **Build fixes:** src/odyssey/ exclusion, tuple syntax
