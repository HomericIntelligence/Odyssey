...
**Key crash:** Segfault in `src/projectodyssey/core/conv.mojo:151:64` during backward pass in `compute_gradients()` → `train_epoch()` → `main()`
...
Epoch [ 1 / 1 ]
 ...
 #5 0x00005d6f44e8f2b1 train::compute_gradients(model::LeNet5&,
    ...
    /examples/lenet_emnist/train.mojo:97:27
 #6 0x00005d6f44e8f2b1 train::train_epoch(model::LeNet5&,
    ...
    /examples/lenet_emnist/train.mojo:233:43
 #7 0x00005d6f44e8f2b1 train::main()
    /examples/lenet_emnist/train.mojo:341:37
...
1. **Debug the conv2d segfault** - Fix gradient computation crash at `src/projectodyssey/core/conv.mojo:151:64`
...
- 1 segfault in `conv2d` during gradient computation (`src/projectodyssey/core/conv.mojo:151:64`)
