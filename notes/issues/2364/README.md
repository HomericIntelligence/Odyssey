...
**Location**: `src/odyssey/training/schedulers/lr_schedulers.mojo` (lines 78-136)
...
**Location**: `src/odyssey/training/schedulers/lr_schedulers.mojo` (lines 144-194)
...
**File**: `tests/odyssey/training/test_schedulers.mojo`
...
**File**: `tests/odyssey/training/test_warmup_scheduler.mojo`
...
**File**: `src/odyssey/training/schedulers/__init__.mojo`
...
```mojo
from odyssey.training.schedulers import CosineAnnealingLR, WarmupLR
```
...
- **Shared Configuration**: `src/odyssey/training/base.mojo` - LRScheduler trait definition
- **Scheduler Module**: `src/odyssey/training/schedulers/`
- **Test Utilities**: `tests/odyssey/conftest.mojo` - Test assertion functions
- **Related Issues**:
...
- [x] CosineAnnealingLR is implemented and accessible via `from odyssey.training.schedulers import CosineAnnealingLR`
- [x] WarmupLR is implemented and accessible via `from odyssey.training.schedulers import WarmupLR`
