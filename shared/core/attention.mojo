...
fn scaled_dot_product_attention_typed[
    dt: DType
](
    query: Tensor[dt], key: Tensor[dt], value: Tensor[dt]
) raises -> Tensor[dt]:
    """Typed overload of scaled_dot_product_attention.
    ...
    return scaled_dot_product_attention(
        query.as_any(), key.as_any(), value.as_any()
    ).as_tensor[dt]()


fn scaled_dot_product_attention_masked_typed[
    dt: DType
](
    query: Tensor[dt],
    key: Tensor[dt],
    ...
    """Typed overload of scaled_dot_product_attention_masked.
    ...
    """
    return scaled_dot_product_attention_masked(
        query.as_any(), key.as_any(), value.as_any(), mask.as_any()
    ).as_tensor[dt]()
