...
def cross_entropy(
    ...
    from shared.core.elementwise import log, exp
...
def focal_loss_backward(
    ...
    Raises:
        ...
        Example:
            ...
            ```
    """
    from shared.core.arithmetic import subtract, multiply, divide, add, power
    from shared.core.elementwise import log, clip
...
def kl_divergence_backward(
    ...
    Raises:
        ...
        Example:
            ...
            ```
    """
    from shared.core.arithmetic import divide, multiply
