...
```bash
gh api repos/HomericIntelligence/Odyssey/pulls/1559/comments/2524809837/replies \
  --method POST \
...
```bash
gh api repos/HomericIntelligence/Odyssey/pulls/1559/comments \
