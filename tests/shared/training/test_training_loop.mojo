...
fn main() raises:
    """Run training loop tests (core + forward + loss).

    ADR-009: Split from original 19 tests to stay under 10 fn limit.
    Backward/weight tests in test_training_loop_part2.mojo.
    Batch/DataLoader tests in test_training_loop_part3.mojo.
    """
    ...
    print("\nAll training loop tests (part 0) passed!")
