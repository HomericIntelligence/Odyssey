...
fn main() raises:
    """Run all view __setitem__ and __getitem__ tests."""
    print("Running view property tests...")
    test_transpose_creates_noncontiguous_view()
    test_slice_creates_view()

    print("Running __getitem__ flat index on transposed view...")
    test_getitem_flat_on_transposed_view()
    test_getitem_flat_on_transposed_3x4_view()

    print("Running __setitem__ flat index on transposed view...")
    ...
    print("Running slice view write-back tests...")
    test_setitem_on_slice_view_writes_to_parent()

    print("Running integer dtype view tests...")
    test_setitem_view_int32_dtype()

    print("All view __setitem__ tests passed!")
