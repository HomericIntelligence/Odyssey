"""Unit tests for loss functions (Part 1 of 2)

Tests cover:
- cross_entropy: Forward pass output shape and basic correctness
- mean_squared_error: Forward pass and shape tests
...
fn main() raises:
    ...
    print("\nAll test_loss_funcs_part1 tests passed!")
