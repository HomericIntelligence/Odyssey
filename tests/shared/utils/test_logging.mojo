...
def main() raises:
    ...
    print("✓ test_log_level_hierarchy")

    test_log_level_filtering()
    print("✓ test_log_level_filtering")

    test_set_global_log_level()
    print("✓ test_set_global_log_level")

    test_simple_formatter()
    print("✓ test_simple_formatter")

    test_timestamp_formatter()
    print("✓ test_timestamp_formatter")

    test_detailed_formatter()
    print("✓ test_detailed_formatter")

    test_colored_output()
    print("✓ test_colored_output")

    test_console_handler()
    print("✓ test_console_handler")

    test_file_handler()
    print("✓ test_file_handler")

    test_multiple_handlers()
    print("✓ test_multiple_handlers")

    test_log_training_start()
    print("✓ test_log_training_start")

    test_log_epoch_metrics()
    print("✓ test_log_epoch_metrics")

    test_log_batch_progress()
    print("✓ test_log_batch_progress")

    test_log_checkpoint_saved()
    print("✓ test_log_checkpoint_saved")

    test_log_early_stopping()
    print("✓ test_log_early_stopping")

    test_create_default_logger()
    print("✓ test_create_default_logger")

    test_create_logger_with_name()
    print("✓ test_create_logger_with_name")

    test_logger_singleton()
    print("✓ test_logger_singleton")

    test_configure_logger_from_dict()
    print("✓ test_configure_logger_from_dict")

    test_log_with_invalid_level()
    print("✓ test_log_with_invalid_level")

    test_file_handler_permission_error()
    print("✓ test_file_handler_permission_error")

    test_logger_integration_training()
    print("✓ test_logger_integration_training")

    print("\nAll test_logging tests passed!")
