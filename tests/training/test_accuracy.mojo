...
def test_per_class_accuracy() raises:
    ...
    var acc_class0 = per_class_acc._data.unsafe_bitcast[Float64]()[0]
    var acc_class1 = per_class_acc._data.unsafe_bitcast[Float64]()[1]
    var acc_class2 = per_class_acc._data.unsafe_bitcast[Float64]()[2]
