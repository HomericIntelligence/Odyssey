...
def test_tensor_float64_creation() raises:
...
def test_tensor_shape_strides() raises:
...
def test_tensor_getitem_returns_typed() raises:
...
def test_tensor_str_output() raises:
...
def test_tensor_getitem_float64_typed() raises:
    ...
    t._data[unsafe_offset=0] = Scalar[DType.float64](0.25)
    var val = t[0]
...
def test_tensor_item_single_element() raises:
...
def test_tensor_item_raises_multi_element() raises:
...
def test_tensor_bool_single_element() raises:
...
def test_tensor_bool_raises_multi_element() raises:
