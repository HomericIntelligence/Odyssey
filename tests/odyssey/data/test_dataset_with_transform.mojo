...
def test_transformed_dataset_applies_transform() raises:
    ...
    var transformed_first = transformed_data._data.unsafe_bitcast[Float32]()[0]
...
def test_transformed_dataset_preserves_labels() raises:
    ...
    var trans_first = transformed_labels._data.unsafe_bitcast[Float32]()[0]
...
def test_transformed_dataset_all_samples() raises:
    ...
    for i in range(3):
        ...
        var trans_first = trans_data._data.unsafe_bitcast[Float32]()[0]
