...
def test_uint8_not_zero() raises:
...
def test_uint8_not_alternating() raises:
...
def test_uint8_double_inversion() raises:
...
def test_uint16_not_zero() raises:
...
def test_uint16_not_max() raises:
...
def test_uint16_not_alternating() raises:
...
def test_uint16_double_inversion() raises:
...
def test_uint32_not_zero() raises:
...
def test_uint32_not_max() raises:
...
def test_uint32_not_alternating() raises:
...
def test_uint32_double_inversion() raises:
...
def test_uint64_not_zero() raises:
...
def test_uint64_not_max() raises:
...
def test_uint64_not_alternating() raises:
...
def test_uint64_double_inversion() raises:
