...
def test_batchnorm_forward_training_mode() raises:
    ...
    var running_mean_data = layer.running_mean._data.unsafe_bitcast[Float32]()
    var running_var_data = layer.running_var._data.unsafe_bitcast[Float32]()
...
def test_batchnorm_get_running_stats() raises:
    ...
    var mean_data = mean._data.unsafe_bitcast[Float32]()
...
def test_batchnorm_running_stats_update_over_batches() raises:
    ...
    var mean_data2 = mean2._data.unsafe_bitcast[Float32]()
