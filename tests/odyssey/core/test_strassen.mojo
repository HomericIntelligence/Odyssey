...
def test_strassen_2x2_float32() raises:
    ...
    var c_ptr = C.data_ptr[DType.float32]()
...
def test_strassen_4x4_float32() raises:
    ...
    # Compare results
    var strassen_ptr = C_strassen.data_ptr[DType.float32]()
    var ref_ptr = C_ref.data_ptr[DType.float32]()
...
def test_strassen_8x8_float64() raises:
    ...
    var a_ptr = A.data_ptr[DType.float64]()
    var b_ptr = B.data_ptr[DType.float64]()
    ...
    # Compare results
    var strassen_ptr = C_strassen.data_ptr[DType.float64]()
    var ref_ptr = C_ref.data_ptr[DType.float64]()
