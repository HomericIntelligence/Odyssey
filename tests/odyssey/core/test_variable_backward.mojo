...
def test_variable_backward_scalar_loss() raises:
    ...
    var grad_val = grad_x._data.unsafe_bitcast[Float32]()[unsafe_offset=0]
...
def test_variable_backward_multiple_variables() raises:
    ...
    # Check first element
    var grad_x_0 = grad_x._data.unsafe_bitcast[Float32]()[unsafe_offset=0]
    var grad_y_0 = grad_y._data.unsafe_bitcast[Float32]()[unsafe_offset=0]
...
def test_variable_backward_independent_tapes() raises:
    ...
    var grad1_0 = grad1_x1._data.unsafe_bitcast[Float32]()[unsafe_offset=0]
    var grad2_0 = grad2_x2._data.unsafe_bitcast[Float32]()[unsafe_offset=0]
