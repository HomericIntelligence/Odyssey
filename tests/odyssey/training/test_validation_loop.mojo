...
def test_confusion_matrix_binary_counts() raises:
    ...
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[0]), 1)  # TN
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[1]), 1)  # FP
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[2]), 1)  # FN
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[3]), 1)  # TP
...
def test_confusion_matrix_all_correct() raises:
    ...
    var raw = cm.normalize(mode="none")
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[0]), 2)  # TN=2
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[1]), 0)  # FP=0
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[2]), 0)  # FN=0
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[3]), 2)  # TP=2
...
def test_confusion_matrix_all_wrong() raises:
    ...
    var raw = cm.normalize(mode="none")
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[0]), 0)  # TN=0
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[1]), 2)  # FP=2
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[2]), 2)  # FN=2
    assert_equal_int(Int(raw._data.unsafe_bitcast[Float64]()[3]), 0)  # TP=0
...
def test_validation_loop_confusion_matrix_integration() raises:
    ...
    # Matrix layout: raw[row*2 + col] where row=true, col=pred
    assert_equal_int(
        Int(raw._data.unsafe_bitcast[Float64]()[0]), 1
    )  # [0,0] TN=1
    assert_equal_int(
        Int(raw._data.unsafe_bitcast[Float64]()[1]), 1
    )  # [0,1] FP=1
    assert_equal_int(
        Int(raw._data.unsafe_bitcast[Float64]()[2]), 1
    )  # [1,0] FN=1
    assert_equal_int(
        Int(raw._data.unsafe_bitcast[Float64]()[3]), 1
    )  # [1,1] TP=1
