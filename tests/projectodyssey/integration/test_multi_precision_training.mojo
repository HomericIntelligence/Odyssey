...
def main() raises:
    ...
    print("✓ test_fp32_training_loss_decreases")

    test_fp16_training_loss_decreases()
    print("✓ test_fp16_training_loss_decreases")

    test_bf16_training_loss_decreases()
    print("✓ test_bf16_training_loss_decreases")

    test_fp8_training_loss_decreases()
    print("✓ test_fp8_training_loss_decreases")

    test_fp16_gradient_overflow_recovery()
    print("✓ test_fp16_gradient_overflow_recovery")

    test_precision_config_from_string()
    print("✓ test_precision_config_from_string")

    test_precision_config_invalid_string()
    print("✓ test_precision_config_invalid_string")

    test_gradient_scaler_dynamic_scaling()
    print("✓ test_gradient_scaler_dynamic_scaling")

    test_master_weights_fp32()
    print("✓ test_master_weights_fp32")

    test_fp16_vs_fp32_accuracy()
    print("✓ test_fp16_vs_fp32_accuracy")

    test_bf16_vs_fp32_accuracy()
    print("✓ test_bf16_vs_fp32_accuracy")

    test_mixed_precision_memory_savings()
    print("✓ test_mixed_precision_memory_savings")

    test_training_with_toml_config()
    print("✓ test_training_with_toml_config")

    print("\nAll test_multi_precision_training tests passed!")
