...
def test_assert_greater_or_equal_float32_fails() raises:
    """Test assert_greater_or_equal with a < b (Float32)."""
    var failed = False
    try:
...
def test_assert_less_or_equal_float32_passes() raises:
...
def test_assert_less_or_equal_float32_fails() raises:
    """Test assert_less_or_equal with a > b (Float32)."""
    var failed = False
    try:
...
def test_assert_shape_equal_passes() raises:
...
def test_assert_shape_equal_fails_dimension() raises:
...
def test_assert_shape_equal_fails_size() raises:
...
def test_assert_shape_tensor_passes() raises:
...
def test_assert_shape_tensor_fails() raises:
