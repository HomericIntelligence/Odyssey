...
from projectodyssey.core.shape import reshape, squeeze, unsqueeze, concatenate, stack
...
def test_reshape_to_scalar() raises:
    """Reshape [1] to [] (scalar)."""
...
def test_reshape_from_scalar() raises:
    """Reshape [] to [1, 1, 1]."""
    var shape_from = List[Int]()
    var t = full(shape_from, 42.0, DType.float32)
...
def test_reshape_preserve_size() raises:
...
def test_reshape_empty_tensor() raises:
...
def test_squeeze_size_one_dim() raises:
    """Squeeze [1, 3, 1, 4] -> [3, 4]."""
    var shape = List[Int]()
    shape.append(1)
    shape.append(3)
...
def test_squeeze_all_size_one() raises:
    """Squeeze [1, 1, 1] -> []."""
    var shape = List[Int]()
    shape.append(1)
    shape.append(1)
...
def test_squeeze_no_size_one() raises:
...
def test_squeeze_1d_with_size_one() raises:
    """Squeeze [1] -> []."""
    var shape = List[Int]()
    shape.append(1)
...
def test_unsqueeze_scalar() raises:
...
def test_unsqueeze_1d_at_end() raises:
...
def test_concatenate_single_tensor() raises:
...
def test_concatenate_along_axis_0() raises:
...
def test_concatenate_along_axis_1() raises:
...
def test_concatenate_with_empty() raises:
...
def test_concatenate_1d_tensors() raises:
...
def test_stack_2d_tensors() raises:
    """Stack 2D tensors."""
    var shape = List[Int]()
    shape.append(2)
    shape.append(3)
...
def test_stack_along_different_axis() raises:
...
def test_squeeze_preserves_numel() raises:
...
def test_unsqueeze_preserves_numel() raises:
