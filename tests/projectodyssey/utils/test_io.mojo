...
def main() raises:
    ...
    print("✓ test_save_to_readonly_directory")

    test_load_corrupted_checkpoint()
    print("✓ test_load_corrupted_checkpoint")

    test_disk_full_error()
    print("✓ test_disk_full_error")

    test_save_compressed_checkpoint()
    print("✓ test_save_compressed_checkpoint")

    test_compression_formats()
    print("✓ test_compression_formats")

    test_checkpoint_integration_training()
    print("✓ test_checkpoint_integration_training")

    test_resume_training_from_checkpoint()
    print("✓ test_resume_training_from_checkpoint")

    print("\nAll test_io tests passed!")
