...
def test_nvfp4_block_creation_range() raises:
...
def test_nvfp4_block_size_validation() raises:
...
def test_nvfp4_block_roundtrip_small() raises:
...
def test_nvfp4_block_roundtrip_large() raises:
...
def test_nvfp4_block_roundtrip_mixed_signs() raises:
...
def test_nvfp4_block_scale_computation() raises:
...
def test_nvfp4_block_bit_packing() raises:
...
def test_nvfp4_block_get() raises:
...
def test_nvfp4_block_get_bounds_checking() raises:
...
def test_nvfp4_block_set_bounds_checking() raises:
...
def test_nvfp4_block_all_negative_range() raises:
...
def test_nvfp4_block_nan_values() raises:
...
def test_nvfp4_block_infinity_values() raises:
...
def test_nvfp4_block_mixed_special() raises:
...
def test_nvfp4_block_extreme_range() raises:
...
def main() raises:
    """Run all test_nvfp4_block tests."""
    print("Running test_nvfp4_block tests...")

    test_nvfp4_block_creation_zeros()
    print("✓ test_nvfp4_block_creation_zeros")

    test_nvfp4_block_creation_ones()
    print("✓ test_nvfp4_block_creation_ones")

    test_nvfp4_block_creation_range()
    print("✓ test_nvfp4_block_creation_range")

    test_nvfp4_block_size_validation()
    print("✓ test_nvfp4_block_size_validation")

    test_nvfp4_block_roundtrip_small()
    print("✓ test_nvfp4_block_roundtrip_small")

    test_nvfp4_block_roundtrip_large()
    print("✓ test_nvfp4_block_roundtrip_large")

    test_nvfp4_block_roundtrip_mixed_signs()
    print("✓ test_nvfp4_block_roundtrip_mixed_signs")

    test_nvfp4_block_scale_computation()
    print("✓ test_nvfp4_block_scale_computation")

    test_nvfp4_better_accuracy_than_mxfp4()
    print("✓ test_nvfp4_better_accuracy_than_mxfp4")

    test_nvfp4_block_bit_packing()
    print("✓ test_nvfp4_block_bit_packing")

    test_nvfp4_block_get()
    print("✓ test_nvfp4_block_get")

    test_nvfp4_block_get_bounds_checking()
    print("✓ test_nvfp4_block_get_bounds_checking")

    test_nvfp4_block_set()
    print("✓ test_nvfp4_block_set")

    test_nvfp4_block_set_bounds_checking()
    print("✓ test_nvfp4_block_set_bounds_checking")

    test_nvfp4_block_all_negative_same()
    print("✓ test_nvfp4_block_all_negative_same")

    test_nvfp4_block_all_negative_range()
    print("✓ test_nvfp4_block_all_negative_range")

    test_nvfp4_block_negative_scale_computation()
    print("✓ test_nvfp4_block_negative_scale_computation")

    test_nvfp4_block_nan_values()
    print("✓ test_nvfp4_block_nan_values")

    test_nvfp4_block_infinity_values()
    print("✓ test_nvfp4_block_infinity_values")

    test_nvfp4_block_mixed_special()
    print("✓ test_nvfp4_block_mixed_special")

    test_nvfp4_block_all_same_value()
    print("✓ test_nvfp4_block_all_same_value")

    test_nvfp4_block_extreme_range()
    print("✓ test_nvfp4_block_extreme_range")

    print("\nAll test_nvfp4_block tests passed!")
