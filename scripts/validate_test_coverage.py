...
def find_test_files(root_dir: Path) -> List[Path]:
    ...
    exclude_training_patterns = [
        "tests/odyssey/training/test_accuracy_bugs.mojo",
        "tests/odyssey/training/test_base.mojo",
        "tests/odyssey/training/test_callbacks_part1.mojo",
        "tests/odyssey/training/test_callbacks_part2.mojo",
        "tests/odyssey/training/test_callbacks_part3.mojo",
        "tests/odyssey/training/test_callbacks.mojo",
        "tests/odyssey/training/test_checkpoint.mojo",
        "tests/odyssey/training/test_checkpointing.mojo",
        "tests/odyssey/training/test_config.mojo",
        "tests/odyssey/training/test_confusion_matrix_bugs.mojo",
        "tests/odyssey/training/test_csv_metrics_logger.mojo",
        "tests/odyssey/training/test_dtype_utils.mojo",
        "tests/odyssey/training/test_early_stopping_part1.mojo",
        "tests/odyssey/training/test_early_stopping_part2.mojo",
        "tests/odyssey/training/test_evaluate.mojo",
        "tests/odyssey/training/test_evaluation_part1.mojo",
        "tests/odyssey/training/test_evaluation_part2.mojo",
        "tests/odyssey/training/test_evaluation.mojo",
        "tests/odyssey/training/test_exponential_scheduler.mojo",
        "tests/odyssey/training/test_gradient_clipping.mojo",
        "tests/odyssey/training/test_gradient_ops.mojo",
        "tests/odyssey/training/test_lars.mojo",
        "tests/odyssey/training/test_logging_callback_part1.mojo",
        "tests/odyssey/training/test_logging_callback_part2.mojo",
        "tests/odyssey/training/test_loops.mojo",
        "tests/odyssey/training/test_metrics_part1.mojo",
        "tests/odyssey/training/test_metrics_part2.mojo",
        "tests/odyssey/training/test_mixed_precision.mojo",
        "tests/odyssey/training/test_optimizer_utils_part1.mojo",
        "tests/odyssey/training/test_optimizer_utils_part2.mojo",
        "tests/odyssey/training/test_mixed_precision_simd.mojo",
        "tests/odyssey/training/test_multistep_scheduler.mojo",
        "tests/odyssey/training/test_optimizer_utils.mojo",
        "tests/odyssey/training/test_optimizers.mojo",
        "tests/odyssey/training/test_precision_checkpoint.mojo",
        "tests/odyssey/training/test_precision_config.mojo",
        "tests/odyssey/training/test_results_printer_part1.mojo",
        "tests/odyssey/training/test_results_printer_part2.mojo",
        "tests/odyssey/training/test_results_printer_part3.mojo",
        "tests/odyssey/training/test_rmsprop.mojo",
        "tests/odyssey/training/test_schedulers_part1.mojo",
        "tests/odyssey/training/test_schedulers_part2.mojo",
        "tests/odyssey/training/test_schedulers_part3.mojo",
        "tests/odyssey/training/test_step_scheduler.mojo",
        "tests/odyssey/training/test_trainer_interface_bugs.mojo",
        "tests/odyssey/training/test_training_loop_part1.mojo",
        "tests/odyssey/training/test_training_loop_part2.mojo",
        "tests/odyssey/training/test_training_loop_part3.mojo",
        "tests/odyssey/training/test_validation_loop.mojo",
        "tests/odyssey/training/test_warmup_composite_scheduler.mojo",
        "tests/odyssey/training/test_warmup_scheduler.mojo",
    ]
