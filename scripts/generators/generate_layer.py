...
Usage:
    python scripts/generators/generate_layer.py \\
        ...
        --output src/projectodyssey/nn/attention.mojo

    python scripts/generators/generate_layer.py \\
        --name SEBlock \\
        --inputs "x:AnyTensor" \\
        --params "reduction:Int=16" \\
        --output src/projectodyssey/nn/se_block.mojo
...
from projectodyssey.nn import Module
...
Examples:
    ...
    python scripts/generators/generate_layer.py \\
        ...
        --no-parameters \\
        --output src/projectodyssey/nn/reshape.mojo
        """,
    )
