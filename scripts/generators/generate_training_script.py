...
from odyssey.datasets.{dataset_snake} import {dataset}Dataset
from odyssey.training import {optimizer_class}, {loss_class}
from odyssey.training.early_stopping import EarlyStopping
