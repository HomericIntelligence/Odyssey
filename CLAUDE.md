...
See [docs/dev/testing-strategy.md](docs/dev/testing-strategy.md) for the complete
two-tier testing strategy, test coverage by model, gradient checking details, and
