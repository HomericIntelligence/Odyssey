...
def compute_gradients(
    ...
    var init_conv_out = conv2d(
        input, model.initial_conv_weights, model.initial_conv_bias,
        stride=2, padding=1,
    )
    var init_bn_tuple = batch_norm2d(
        init_conv_out, model.initial_bn_gamma, model.initial_bn_beta,
        model.initial_bn_running_mean, model.initial_bn_running_var, True,
    )
    ...
    var b1_dw_out = depthwise_conv2d(
        b1_in, model.ds_block_1.dw_weights, model.ds_block_1.dw_bias,
        stride=1, padding=1,
    )
    var b1_dw_bn_tuple = batch_norm2d(
        b1_dw_out, model.ds_block_1.dw_bn_gamma, model.ds_block_1.dw_bn_beta,
        model.ds_block_1.dw_bn_running_mean, model.ds_block_1.dw_bn_running_var, True,
    )
    var b1_dw_bn_out = b1_dw_bn_tuple[0]
    var b1_dw_relu_out = relu(b1_dw_bn_out)
    var b1_pw_out = conv2d(
        b1_dw_relu_out, model.ds_block_1.pw_weights, model.ds_block_1.pw_bias,
        stride=1, padding=0,
    )
    var b1_pw_bn_tuple = batch_norm2d(
        b1_pw_out, model.ds_block_1.pw_bn_gamma, model.ds_block_1.pw_bn_beta,
        model.ds_block_1.pw_bn_running_mean, model.ds_block_1.pw_bn_running_var, True,
    )
    ...
    var b2_dw_out = depthwise_conv2d(
        b2_in, model.ds_block_2.dw_weights, model.ds_block_2.dw_bias,
        stride=2, padding=1,
    )
    var b2_dw_bn_tuple = batch_norm2d(
        b2_dw_out, model.ds_block_2.dw_bn_gamma, model.ds_block_2.dw_bn_beta,
        model.ds_block_2.dw_bn_running_mean, model.ds_block_2.dw_bn_running_var, True,
    )
    var b2_dw_bn_out = b2_dw_bn_tuple[0]
    var b2_dw_relu_out = relu(b2_dw_bn_out)
    var b2_pw_out = conv2d(
        b2_dw_relu_out, model.ds_block_2.pw_weights, model.ds_block_2.pw_bias,
        stride=1, padding=0,
    )
    var b2_pw_bn_tuple = batch_norm2d(
        b2_pw_out, model.ds_block_2.pw_bn_gamma, model.ds_block_2.pw_bn_beta,
        model.ds_block_2.pw_bn_running_mean, model.ds_block_2.pw_bn_running_var, True,
    )
    ...
    var b3_dw_out = depthwise_conv2d(
        b3_in, model.ds_block_3.dw_weights, model.ds_block_3.dw_bias,
        stride=1, padding=1,
    )
    var b3_dw_bn_tuple = batch_norm2d(
        b3_dw_out, model.ds_block_3.dw_bn_gamma, model.ds_block_3.dw_bn_beta,
        model.ds_block_3.dw_bn_running_mean, model.ds_block_3.dw_bn_running_var, True,
    )
    var b3_dw_bn_out = b3_dw_bn_tuple[0]
    var b3_dw_relu_out = relu(b3_dw_bn_out)
    var b3_pw_out = conv2d(
        b3_dw_relu_out, model.ds_block_3.pw_weights, model.ds_block_3.pw_bias,
        stride=1, padding=0,
    )
    var b3_pw_bn_tuple = batch_norm2d(
        b3_pw_out, model.ds_block_3.pw_bn_gamma, model.ds_block_3.pw_bn_beta,
        model.ds_block_3.pw_bn_running_mean, model.ds_block_3.pw_bn_running_var, True,
    )
    ...
    var b4_dw_out = depthwise_conv2d(
        b4_in, model.ds_block_4.dw_weights, model.ds_block_4.dw_bias,
        stride=2, padding=1,
    )
    var b4_dw_bn_tuple = batch_norm2d(
        b4_dw_out, model.ds_block_4.dw_bn_gamma, model.ds_block_4.dw_bn_beta,
        model.ds_block_4.dw_bn_running_mean, model.ds_block_4.dw_bn_running_var, True,
    )
    var b4_dw_bn_out = b4_dw_bn_tuple[0]
    var b4_dw_relu_out = relu(b4_dw_bn_out)
    var b4_pw_out = conv2d(
        b4_dw_relu_out, model.ds_block_4.pw_weights, model.ds_block_4.pw_bias,
        stride=1, padding=0,
    )
    var b4_pw_bn_tuple = batch_norm2d(
        b4_pw_out, model.ds_block_4.pw_bn_gamma, model.ds_block_4.pw_bn_beta,
        model.ds_block_4.pw_bn_running_mean, model.ds_block_4.pw_bn_running_var, True,
    )
    ...
    var b5_dw_out = depthwise_conv2d(
        b5_in, model.ds_block_5.dw_weights, model.ds_block_5.dw_bias,
        stride=1, padding=1,
    )
    var b5_dw_bn_tuple = batch_norm2d(
        b5_dw_out, model.ds_block_5.dw_bn_gamma, model.ds_block_5.dw_bn_beta,
        model.ds_block_5.dw_bn_running_mean, model.ds_block_5.dw_bn_running_var, True,
    )
    var b5_dw_bn_out = b5_dw_bn_tuple[0]
    var b5_dw_relu_out = relu(b5_dw_bn_out)
    var b5_pw_out = conv2d(
        b5_dw_relu_out, model.ds_block_5.pw_weights, model.ds_block_5.pw_bias,
        stride=1, padding=0,
    )
    var b5_pw_bn_tuple = batch_norm2d(
        b5_pw_out, model.ds_block_5.pw_bn_gamma, model.ds_block_5.pw_bn_beta,
        model.ds_block_5.pw_bn_running_mean, model.ds_block_5.pw_bn_running_var, True,
    )
    ...
    var b6_dw_out = depthwise_conv2d(
        b6_in, model.ds_block_6.dw_weights, model.ds_block_6.dw_bias,
        stride=2, padding=1,
    )
    var b6_dw_bn_tuple = batch_norm2d(
        b6_dw_out, model.ds_block_6.dw_bn_gamma, model.ds_block_6.dw_bn_beta,
        model.ds_block_6.dw_bn_running_mean, model.ds_block_6.dw_bn_running_var, True,
    )
    var b6_dw_bn_out = b6_dw_bn_tuple[0]
    var b6_dw_relu_out = relu(b6_dw_bn_out)
    var b6_pw_out = conv2d(
        b6_dw_relu_out, model.ds_block_6.pw_weights, model.ds_block_6.pw_bias,
        stride=1, padding=0,
    )
    var b6_pw_bn_tuple = batch_norm2d(
        b6_pw_out, model.ds_block_6.pw_bn_gamma, model.ds_block_6.pw_bn_beta,
        model.ds_block_6.pw_bn_running_mean, model.ds_block_6.pw_bn_running_var, True,
    )
    ...
    var b7_dw_out = depthwise_conv2d(
        b7_in, model.ds_block_7.dw_weights, model.ds_block_7.dw_bias,
        stride=1, padding=1,
    )
    var b7_dw_bn_tuple = batch_norm2d(
        b7_dw_out, model.ds_block_7.dw_bn_gamma, model.ds_block_7.dw_bn_beta,
        model.ds_block_7.dw_bn_running_mean, model.ds_block_7.dw_bn_running_var, True,
    )
    var b7_dw_bn_out = b7_dw_bn_tuple[0]
    var b7_dw_relu_out = relu(b7_dw_bn_out)
    var b7_pw_out = conv2d(
        b7_dw_relu_out, model.ds_block_7.pw_weights, model.ds_block_7.pw_bias,
        stride=1, padding=0,
    )
    var b7_pw_bn_tuple = batch_norm2d(
        b7_pw_out, model.ds_block_7.pw_bn_gamma, model.ds_block_7.pw_bn_beta,
        model.ds_block_7.pw_bn_running_mean, model.ds_block_7.pw_bn_running_var, True,
    )
    ...
    var b8_dw_out = depthwise_conv2d(
        b8_in, model.ds_block_8.dw_weights, model.ds_block_8.dw_bias,
        stride=1, padding=1,
    )
    var b8_dw_bn_tuple = batch_norm2d(
        b8_dw_out, model.ds_block_8.dw_bn_gamma, model.ds_block_8.dw_bn_beta,
        model.ds_block_8.dw_bn_running_mean, model.ds_block_8.dw_bn_running_var, True,
    )
    var b8_dw_bn_out = b8_dw_bn_tuple[0]
    var b8_dw_relu_out = relu(b8_dw_bn_out)
    var b8_pw_out = conv2d(
        b8_dw_relu_out, model.ds_block_8.pw_weights, model.ds_block_8.pw_bias,
        stride=1, padding=0,
    )
    var b8_pw_bn_tuple = batch_norm2d(
        b8_pw_out, model.ds_block_8.pw_bn_gamma, model.ds_block_8.pw_bn_beta,
        model.ds_block_8.pw_bn_running_mean, model.ds_block_8.pw_bn_running_var, True,
    )
    ...
    var b9_dw_out = depthwise_conv2d(
        b9_in, model.ds_block_9.dw_weights, model.ds_block_9.dw_bias,
        stride=1, padding=1,
    )
    var b9_dw_bn_tuple = batch_norm2d(
        b9_dw_out, model.ds_block_9.dw_bn_gamma, model.ds_block_9.dw_bn_beta,
        model.ds_block_9.dw_bn_running_mean, model.ds_block_9.dw_bn_running_var, True,
    )
    var b9_dw_bn_out = b9_dw_bn_tuple[0]
    var b9_dw_relu_out = relu(b9_dw_bn_out)
    var b9_pw_out = conv2d(
        b9_dw_relu_out, model.ds_block_9.pw_weights, model.ds_block_9.pw_bias,
        stride=1, padding=0,
    )
    var b9_pw_bn_tuple = batch_norm2d(
        b9_pw_out, model.ds_block_9.pw_bn_gamma, model.ds_block_9.pw_bn_beta,
        model.ds_block_9.pw_bn_running_mean, model.ds_block_9.pw_bn_running_var, True,
    )
    ...
    var b10_dw_out = depthwise_conv2d(
        b10_in, model.ds_block_10.dw_weights, model.ds_block_10.dw_bias,
        stride=1, padding=1,
    )
    var b10_dw_bn_tuple = batch_norm2d(
        b10_dw_out, model.ds_block_10.dw_bn_gamma, model.ds_block_10.dw_bn_beta,
        model.ds_block_10.dw_bn_running_mean, model.ds_block_10.dw_bn_running_var, True,
    )
    var b10_dw_bn_out = b10_dw_bn_tuple[0]
    var b10_dw_relu_out = relu(b10_dw_bn_out)
    var b10_pw_out = conv2d(
        b10_dw_relu_out, model.ds_block_10.pw_weights, model.ds_block_10.pw_bias,
        stride=1, padding=0,
    )
    var b10_pw_bn_tuple = batch_norm2d(
        b10_pw_out, model.ds_block_10.pw_bn_gamma, model.ds_block_10.pw_bn_beta,
        model.ds_block_10.pw_bn_running_mean, model.ds_block_10.pw_bn_running_var, True,
    )
    var b10_pw_bn_out = b10_pw_bn_tuple[0]
    var b10_out = relu(b10_pw_bn_out)

    # ---- Block 11 (in=512, out=512, stride=2) ----
    var b11_in = b10_out
    var b11_dw_out = depthwise_conv2d(
        b11_in, model.ds_block_11.dw_weights, model.ds_block_11.dw_bias,
        stride=2, padding=1,
    )
    var b11_dw_bn_tuple = batch_norm2d(
        b11_dw_out, model.ds_block_11.dw_bn_gamma, model.ds_block_11.dw_bn_beta,
        model.ds_block_11.dw_bn_running_mean, model.ds_block_11.dw_bn_running_var, True,
    )
    var b11_dw_bn_out = b11_dw_bn_tuple[0]
    var b11_dw_relu_out = relu(b11_dw_bn_out)
    var b11_pw_out = conv2d(
        b11_dw_relu_out, model.ds_block_11.pw_weights, model.ds_block_11.pw_bias,
        stride=1, padding=0,
    )
    var b11_pw_bn_tuple = batch_norm2d(
        b11_pw_out, model.ds_block_11.pw_bn_gamma, model.ds_block_11.pw_bn_beta,
        model.ds_block_11.pw_bn_running_mean, model.ds_block_11.pw_bn_running_var, True,
    )
    var b11_pw_bn_out = b11_pw_bn_tuple[0]
    var b11_out = relu(b11_pw_bn_out)

    # ---- Block 12 (in=1024, out=1024, stride=1) ----
    var b12_in = b11_out
    var b12_dw_out = depthwise_conv2d(
        b12_in, model.ds_block_12.dw_weights, model.ds_block_12.dw_bias,
        stride=1, padding=1,
    )
    var b12_dw_bn_tuple = batch_norm2d(
        b12_dw_out, model.ds_block_12.dw_bn_gamma, model.ds_block_12.dw_bn_beta,
        model.ds_block_12.dw_bn_running_mean, model.ds_block_12.dw_bn_running_var, True,
    )
    var b12_dw_bn_out = b12_dw_bn_tuple[0]
    var b12_dw_relu_out = relu(b12_dw_bn_out)
    var b12_pw_out = conv2d(
        b12_dw_relu_out, model.ds_block_12.pw_weights, model.ds_block_12.pw_bias,
        stride=1, padding=0,
    )
    var b12_pw_bn_tuple = batch_norm2d(
        b12_pw_out, model.ds_block_12.pw_bn_gamma, model.ds_block_12.pw_bn_beta,
        model.ds_block_12.pw_bn_running_mean, model.ds_block_12.pw_bn_running_var, True,
    )
    ...
    var b13_dw_out = depthwise_conv2d(
        b13_in, model.ds_block_13.dw_weights, model.ds_block_13.dw_bias,
        stride=1, padding=1,
    )
    var b13_dw_bn_tuple = batch_norm2d(
        b13_dw_out, model.ds_block_13.dw_bn_gamma, model.ds_block_13.dw_bn_beta,
        model.ds_block_13.dw_bn_running_mean, model.ds_block_13.dw_bn_running_var, True,
    )
    var b13_dw_bn_out = b13_dw_bn_tuple[0]
    var b13_dw_relu_out = relu(b13_dw_bn_out)
    var b13_pw_out = conv2d(
        b13_dw_relu_out, model.ds_block_13.pw_weights, model.ds_block_13.pw_bias,
        stride=1, padding=0,
    )
    var b13_pw_bn_tuple = batch_norm2d(
        b13_pw_out, model.ds_block_13.pw_bn_gamma, model.ds_block_13.pw_bn_beta,
        model.ds_block_13.pw_bn_running_mean, model.ds_block_13.pw_bn_running_var, True,
    )
    ...
    var b13_pw_bn_bwd = batch_norm2d_backward(
        grad_b13_pw_bn_out, b13_pw_out, model.ds_block_13.pw_bn_gamma,
        model.ds_block_13.pw_bn_running_mean, model.ds_block_13.pw_bn_running_var, True,
    )
    ...
    var b13_pw_grads = conv2d_backward(
        grad_b13_pw_out, b13_dw_relu_out, model.ds_block_13.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b13_dw_bn_bwd = batch_norm2d_backward(
        grad_b13_dw_bn_out, b13_dw_out, model.ds_block_13.dw_bn_gamma,
        model.ds_block_13.dw_bn_running_mean, model.ds_block_13.dw_bn_running_var, True,
    )
    ...
    var b13_dw_grads = depthwise_conv2d_backward(
        grad_b13_dw_out, b13_in, model.ds_block_13.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b12_pw_bn_bwd = batch_norm2d_backward(
        grad_b12_pw_bn_out, b12_pw_out, model.ds_block_12.pw_bn_gamma,
        model.ds_block_12.pw_bn_running_mean, model.ds_block_12.pw_bn_running_var, True,
    )
    ...
    var b12_pw_grads = conv2d_backward(
        grad_b12_pw_out, b12_dw_relu_out, model.ds_block_12.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b12_dw_bn_bwd = batch_norm2d_backward(
        grad_b12_dw_bn_out, b12_dw_out, model.ds_block_12.dw_bn_gamma,
        model.ds_block_12.dw_bn_running_mean, model.ds_block_12.dw_bn_running_var, True,
    )
    ...
    var b12_dw_grads = depthwise_conv2d_backward(
        grad_b12_dw_out, b12_in, model.ds_block_12.dw_weights,
        stride=1, padding=1,
    )
    ...
    # ---- Block 11 backward (in=512, out=1024, stride=2) ----
    ...
    var b11_pw_bn_bwd = batch_norm2d_backward(
        grad_b11_pw_bn_out, b11_pw_out, model.ds_block_11.pw_bn_gamma,
        model.ds_block_11.pw_bn_running_mean, model.ds_block_11.pw_bn_running_var, True,
    )
    ...
    var b11_pw_grads = conv2d_backward(
        grad_b11_pw_out, b11_dw_relu_out, model.ds_block_11.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b11_dw_bn_bwd = batch_norm2d_backward(
        grad_b11_dw_bn_out, b11_dw_out, model.ds_block_11.dw_bn_gamma,
        model.ds_block_11.dw_bn_running_mean, model.ds_block_11.dw_bn_running_var, True,
    )
    ...
    var b11_dw_grads = depthwise_conv2d_backward(
        grad_b11_dw_out, b11_in, model.ds_block_11.dw_weights,
        stride=2, padding=1,
    )
    ...
    var b10_pw_bn_bwd = batch_norm2d_backward(
        grad_b10_pw_bn_out, b10_pw_out, model.ds_block_10.pw_bn_gamma,
        model.ds_block_10.pw_bn_running_mean, model.ds_block_10.pw_bn_running_var, True,
    )
    ...
    var b10_pw_grads = conv2d_backward(
        grad_b10_pw_out, b10_dw_relu_out, model.ds_block_10.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b10_dw_bn_bwd = batch_norm2d_backward(
        grad_b10_dw_bn_out, b10_dw_out, model.ds_block_10.dw_bn_gamma,
        model.ds_block_10.dw_bn_running_mean, model.ds_block_10.dw_bn_running_var, True,
    )
    ...
    var b10_dw_grads = depthwise_conv2d_backward(
        grad_b10_dw_out, b10_in, model.ds_block_10.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b9_pw_bn_bwd = batch_norm2d_backward(
        grad_b9_pw_bn_out, b9_pw_out, model.ds_block_9.pw_bn_gamma,
        model.ds_block_9.pw_bn_running_mean, model.ds_block_9.pw_bn_running_var, True,
    )
    ...
    var b9_pw_grads = conv2d_backward(
        grad_b9_pw_out, b9_dw_relu_out, model.ds_block_9.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b9_dw_bn_bwd = batch_norm2d_backward(
        grad_b9_dw_bn_out, b9_dw_out, model.ds_block_9.dw_bn_gamma,
        model.ds_block_9.dw_bn_running_mean, model.ds_block_9.dw_bn_running_var, True,
    )
    ...
    var b9_dw_grads = depthwise_conv2d_backward(
        grad_b9_dw_out, b9_in, model.ds_block_9.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b8_pw_bn_bwd = batch_norm2d_backward(
        grad_b8_pw_bn_out, b8_pw_out, model.ds_block_8.pw_bn_gamma,
        model.ds_block_8.pw_bn_running_mean, model.ds_block_8.pw_bn_running_var, True,
    )
    ...
    var b8_pw_grads = conv2d_backward(
        grad_b8_pw_out, b8_dw_relu_out, model.ds_block_8.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b8_dw_bn_bwd = batch_norm2d_backward(
        grad_b8_dw_bn_out, b8_dw_out, model.ds_block_8.dw_bn_gamma,
        model.ds_block_8.dw_bn_running_mean, model.ds_block_8.dw_bn_running_var, True,
    )
    ...
    var b8_dw_grads = depthwise_conv2d_backward(
        grad_b8_dw_out, b8_in, model.ds_block_8.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b7_pw_bn_bwd = batch_norm2d_backward(
        grad_b7_pw_bn_out, b7_pw_out, model.ds_block_7.pw_bn_gamma,
        model.ds_block_7.pw_bn_running_mean, model.ds_block_7.pw_bn_running_var, True,
    )
    ...
    var b7_pw_grads = conv2d_backward(
        grad_b7_pw_out, b7_dw_relu_out, model.ds_block_7.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b7_dw_bn_bwd = batch_norm2d_backward(
        grad_b7_dw_bn_out, b7_dw_out, model.ds_block_7.dw_bn_gamma,
        model.ds_block_7.dw_bn_running_mean, model.ds_block_7.dw_bn_running_var, True,
    )
    ...
    var b7_dw_grads = depthwise_conv2d_backward(
        grad_b7_dw_out, b7_in, model.ds_block_7.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b6_pw_bn_bwd = batch_norm2d_backward(
        grad_b6_pw_bn_out, b6_pw_out, model.ds_block_6.pw_bn_gamma,
        model.ds_block_6.pw_bn_running_mean, model.ds_block_6.pw_bn_running_var, True,
    )
    ...
    var b6_pw_grads = conv2d_backward(
        grad_b6_pw_out, b6_dw_relu_out, model.ds_block_6.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b6_dw_bn_bwd = batch_norm2d_backward(
        grad_b6_dw_bn_out, b6_dw_out, model.ds_block_6.dw_bn_gamma,
        model.ds_block_6.dw_bn_running_mean, model.ds_block_6.dw_bn_running_var, True,
    )
    ...
    var b6_dw_grads = depthwise_conv2d_backward(
        grad_b6_dw_out, b6_in, model.ds_block_6.dw_weights,
        stride=2, padding=1,
    )
    ...
    var b5_pw_bn_bwd = batch_norm2d_backward(
        grad_b5_pw_bn_out, b5_pw_out, model.ds_block_5.pw_bn_gamma,
        model.ds_block_5.pw_bn_running_mean, model.ds_block_5.pw_bn_running_var, True,
    )
    ...
    var b5_pw_grads = conv2d_backward(
        grad_b5_pw_out, b5_dw_relu_out, model.ds_block_5.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b5_dw_bn_bwd = batch_norm2d_backward(
        grad_b5_dw_bn_out, b5_dw_out, model.ds_block_5.dw_bn_gamma,
        model.ds_block_5.dw_bn_running_mean, model.ds_block_5.dw_bn_running_var, True,
    )
    ...
    var b5_dw_grads = depthwise_conv2d_backward(
        grad_b5_dw_out, b5_in, model.ds_block_5.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b4_pw_bn_bwd = batch_norm2d_backward(
        grad_b4_pw_bn_out, b4_pw_out, model.ds_block_4.pw_bn_gamma,
        model.ds_block_4.pw_bn_running_mean, model.ds_block_4.pw_bn_running_var, True,
    )
    ...
    var b4_pw_grads = conv2d_backward(
        grad_b4_pw_out, b4_dw_relu_out, model.ds_block_4.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b4_dw_bn_bwd = batch_norm2d_backward(
        grad_b4_dw_bn_out, b4_dw_out, model.ds_block_4.dw_bn_gamma,
        model.ds_block_4.dw_bn_running_mean, model.ds_block_4.dw_bn_running_var, True,
    )
    ...
    var b4_dw_grads = depthwise_conv2d_backward(
        grad_b4_dw_out, b4_in, model.ds_block_4.dw_weights,
        stride=2, padding=1,
    )
    ...
    var b3_pw_bn_bwd = batch_norm2d_backward(
        grad_b3_pw_bn_out, b3_pw_out, model.ds_block_3.pw_bn_gamma,
        model.ds_block_3.pw_bn_running_mean, model.ds_block_3.pw_bn_running_var, True,
    )
    ...
    var b3_pw_grads = conv2d_backward(
        grad_b3_pw_out, b3_dw_relu_out, model.ds_block_3.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b3_dw_bn_bwd = batch_norm2d_backward(
        grad_b3_dw_bn_out, b3_dw_out, model.ds_block_3.dw_bn_gamma,
        model.ds_block_3.dw_bn_running_mean, model.ds_block_3.dw_bn_running_var, True,
    )
    ...
    var b3_dw_grads = depthwise_conv2d_backward(
        grad_b3_dw_out, b3_in, model.ds_block_3.dw_weights,
        stride=1, padding=1,
    )
    ...
    var b2_pw_bn_bwd = batch_norm2d_backward(
        grad_b2_pw_bn_out, b2_pw_out, model.ds_block_2.pw_bn_gamma,
        model.ds_block_2.pw_bn_running_mean, model.ds_block_2.pw_bn_running_var, True,
    )
    ...
    var b2_pw_grads = conv2d_backward(
        grad_b2_pw_out, b2_dw_relu_out, model.ds_block_2.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b2_dw_bn_bwd = batch_norm2d_backward(
        grad_b2_dw_bn_out, b2_dw_out, model.ds_block_2.dw_bn_gamma,
        model.ds_block_2.dw_bn_running_mean, model.ds_block_2.dw_bn_running_var, True,
    )
    ...
    var b2_dw_grads = depthwise_conv2d_backward(
        grad_b2_dw_out, b2_in, model.ds_block_2.dw_weights,
        stride=2, padding=1,
    )
    ...
    var b1_pw_bn_bwd = batch_norm2d_backward(
        grad_b1_pw_bn_out, b1_pw_out, model.ds_block_1.pw_bn_gamma,
        model.ds_block_1.pw_bn_running_mean, model.ds_block_1.pw_bn_running_var, True,
    )
    ...
    var b1_pw_grads = conv2d_backward(
        grad_b1_pw_out, b1_dw_relu_out, model.ds_block_1.pw_weights,
        stride=1, padding=0,
    )
    ...
    var b1_dw_bn_bwd = batch_norm2d_backward(
        grad_b1_dw_bn_out, b1_dw_out, model.ds_block_1.dw_bn_gamma,
        model.ds_block_1.dw_bn_running_mean, model.ds_block_1.dw_bn_running_var, True,
    )
    ...
    var b1_dw_grads = depthwise_conv2d_backward(
        grad_b1_dw_out, b1_in, model.ds_block_1.dw_weights,
        stride=1, padding=1,
    )
    ...
    var init_bn_bwd = batch_norm2d_backward(
        grad_init_bn_out, init_conv_out, model.initial_bn_gamma,
        model.initial_bn_running_mean, model.initial_bn_running_var, True,
    )
    ...
    var init_conv_grads = conv2d_backward(
        grad_init_conv_out, input, model.initial_conv_weights, stride=2, padding=1,
    )
    ...
    sgd_momentum_update_inplace(model.initial_conv_weights, grad_init_conv_w, velocities[0],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.initial_conv_bias,    grad_init_conv_b, velocities[1],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.initial_bn_gamma,     grad_init_bn_gamma, velocities[2], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.initial_bn_beta,      grad_init_bn_beta,  velocities[3], Float64(learning_rate), Float64(momentum))

    # Block 1 (base=4):
    sgd_momentum_update_inplace(model.ds_block_1.dw_weights,  grad_b1_dw_w,     velocities[4],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.dw_bias,     grad_b1_dw_b,     velocities[5],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.dw_bn_gamma, grad_b1_dw_gamma, velocities[6],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.dw_bn_beta,  grad_b1_dw_beta,  velocities[7],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.pw_weights,  grad_b1_pw_w,     velocities[8],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.pw_bias,     grad_b1_pw_b,     velocities[9],  Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.pw_bn_gamma, grad_b1_pw_gamma, velocities[10], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_1.pw_bn_beta,  grad_b1_pw_beta,  velocities[11], Float64(learning_rate), Float64(momentum))

    # Block 2 (base=12):
    sgd_momentum_update_inplace(model.ds_block_2.dw_weights,  grad_b2_dw_w,     velocities[12], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.dw_bias,     grad_b2_dw_b,     velocities[13], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.dw_bn_gamma, grad_b2_dw_gamma, velocities[14], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.dw_bn_beta,  grad_b2_dw_beta,  velocities[15], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.pw_weights,  grad_b2_pw_w,     velocities[16], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.pw_bias,     grad_b2_pw_b,     velocities[17], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.pw_bn_gamma, grad_b2_pw_gamma, velocities[18], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_2.pw_bn_beta,  grad_b2_pw_beta,  velocities[19], Float64(learning_rate), Float64(momentum))

    # Block 3 (base=20):
    sgd_momentum_update_inplace(model.ds_block_3.dw_weights,  grad_b3_dw_w,     velocities[20], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.dw_bias,     grad_b3_dw_b,     velocities[21], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.dw_bn_gamma, grad_b3_dw_gamma, velocities[22], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.dw_bn_beta,  grad_b3_dw_beta,  velocities[23], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.pw_weights,  grad_b3_pw_w,     velocities[24], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.pw_bias,     grad_b3_pw_b,     velocities[25], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.pw_bn_gamma, grad_b3_pw_gamma, velocities[26], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_3.pw_bn_beta,  grad_b3_pw_beta,  velocities[27], Float64(learning_rate), Float64(momentum))

    # Block 4 (base=28):
    sgd_momentum_update_inplace(model.ds_block_4.dw_weights,  grad_b4_dw_w,     velocities[28], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.dw_bias,     grad_b4_dw_b,     velocities[29], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.dw_bn_gamma, grad_b4_dw_gamma, velocities[30], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.dw_bn_beta,  grad_b4_dw_beta,  velocities[31], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.pw_weights,  grad_b4_pw_w,     velocities[32], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.pw_bias,     grad_b4_pw_b,     velocities[33], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.pw_bn_gamma, grad_b4_pw_gamma, velocities[34], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_4.pw_bn_beta,  grad_b4_pw_beta,  velocities[35], Float64(learning_rate), Float64(momentum))

    # Block 5 (base=36):
    sgd_momentum_update_inplace(model.ds_block_5.dw_weights,  grad_b5_dw_w,     velocities[36], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.dw_bias,     grad_b5_dw_b,     velocities[37], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.dw_bn_gamma, grad_b5_dw_gamma, velocities[38], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.dw_bn_beta,  grad_b5_dw_beta,  velocities[39], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.pw_weights,  grad_b5_pw_w,     velocities[40], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.pw_bias,     grad_b5_pw_b,     velocities[41], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.pw_bn_gamma, grad_b5_pw_gamma, velocities[42], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_5.pw_bn_beta,  grad_b5_pw_beta,  velocities[43], Float64(learning_rate), Float64(momentum))

    # Block 6 (base=44):
    sgd_momentum_update_inplace(model.ds_block_6.dw_weights,  grad_b6_dw_w,     velocities[44], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.dw_bias,     grad_b6_dw_b,     velocities[45], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.dw_bn_gamma, grad_b6_dw_gamma, velocities[46], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.dw_bn_beta,  grad_b6_dw_beta,  velocities[47], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.pw_weights,  grad_b6_pw_w,     velocities[48], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.pw_bias,     grad_b6_pw_b,     velocities[49], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.pw_bn_gamma, grad_b6_pw_gamma, velocities[50], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_6.pw_bn_beta,  grad_b6_pw_beta,  velocities[51], Float64(learning_rate), Float64(momentum))

    # Block 7 (base=52):
    sgd_momentum_update_inplace(model.ds_block_7.dw_weights,  grad_b7_dw_w,     velocities[52], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.dw_bias,     grad_b7_dw_b,     velocities[53], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.dw_bn_gamma, grad_b7_dw_gamma, velocities[54], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.dw_bn_beta,  grad_b7_dw_beta,  velocities[55], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.pw_weights,  grad_b7_pw_w,     velocities[56], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.pw_bias,     grad_b7_pw_b,     velocities[57], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.pw_bn_gamma, grad_b7_pw_gamma, velocities[58], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_7.pw_bn_beta,  grad_b7_pw_beta,  velocities[59], Float64(learning_rate), Float64(momentum))

    # Block 8 (base=60):
    sgd_momentum_update_inplace(model.ds_block_8.dw_weights,  grad_b8_dw_w,     velocities[60], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.dw_bias,     grad_b8_dw_b,     velocities[61], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.dw_bn_gamma, grad_b8_dw_gamma, velocities[62], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.dw_bn_beta,  grad_b8_dw_beta,  velocities[63], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.pw_weights,  grad_b8_pw_w,     velocities[64], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.pw_bias,     grad_b8_pw_b,     velocities[65], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.pw_bn_gamma, grad_b8_pw_gamma, velocities[66], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_8.pw_bn_beta,  grad_b8_pw_beta,  velocities[67], Float64(learning_rate), Float64(momentum))

    # Block 9 (base=68):
    sgd_momentum_update_inplace(model.ds_block_9.dw_weights,  grad_b9_dw_w,     velocities[68], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.dw_bias,     grad_b9_dw_b,     velocities[69], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.dw_bn_gamma, grad_b9_dw_gamma, velocities[70], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.dw_bn_beta,  grad_b9_dw_beta,  velocities[71], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.pw_weights,  grad_b9_pw_w,     velocities[72], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.pw_bias,     grad_b9_pw_b,     velocities[73], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.pw_bn_gamma, grad_b9_pw_gamma, velocities[74], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_9.pw_bn_beta,  grad_b9_pw_beta,  velocities[75], Float64(learning_rate), Float64(momentum))

    # Block 10 (base=76):
    sgd_momentum_update_inplace(model.ds_block_10.dw_weights,  grad_b10_dw_w,     velocities[76], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.dw_bias,     grad_b10_dw_b,     velocities[77], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.dw_bn_gamma, grad_b10_dw_gamma, velocities[78], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.dw_bn_beta,  grad_b10_dw_beta,  velocities[79], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.pw_weights,  grad_b10_pw_w,     velocities[80], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.pw_bias,     grad_b10_pw_b,     velocities[81], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.pw_bn_gamma, grad_b10_pw_gamma, velocities[82], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_10.pw_bn_beta,  grad_b10_pw_beta,  velocities[83], Float64(learning_rate), Float64(momentum))

    # Block 11 (base=84):
    sgd_momentum_update_inplace(model.ds_block_11.dw_weights,  grad_b11_dw_w,     velocities[84], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.dw_bias,     grad_b11_dw_b,     velocities[85], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.dw_bn_gamma, grad_b11_dw_gamma, velocities[86], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.dw_bn_beta,  grad_b11_dw_beta,  velocities[87], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.pw_weights,  grad_b11_pw_w,     velocities[88], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.pw_bias,     grad_b11_pw_b,     velocities[89], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.pw_bn_gamma, grad_b11_pw_gamma, velocities[90], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_11.pw_bn_beta,  grad_b11_pw_beta,  velocities[91], Float64(learning_rate), Float64(momentum))

    # Block 12 (base=92):
    sgd_momentum_update_inplace(model.ds_block_12.dw_weights,  grad_b12_dw_w,     velocities[92], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.dw_bias,     grad_b12_dw_b,     velocities[93], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.dw_bn_gamma, grad_b12_dw_gamma, velocities[94], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.dw_bn_beta,  grad_b12_dw_beta,  velocities[95], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.pw_weights,  grad_b12_pw_w,     velocities[96], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.pw_bias,     grad_b12_pw_b,     velocities[97], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.pw_bn_gamma, grad_b12_pw_gamma, velocities[98], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_12.pw_bn_beta,  grad_b12_pw_beta,  velocities[99], Float64(learning_rate), Float64(momentum))

    # Block 13 (base=100):
    sgd_momentum_update_inplace(model.ds_block_13.dw_weights,  grad_b13_dw_w,     velocities[100], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.dw_bias,     grad_b13_dw_b,     velocities[101], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.dw_bn_gamma, grad_b13_dw_gamma, velocities[102], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.dw_bn_beta,  grad_b13_dw_beta,  velocities[103], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.pw_weights,  grad_b13_pw_w,     velocities[104], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.pw_bias,     grad_b13_pw_b,     velocities[105], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.pw_bn_gamma, grad_b13_pw_gamma, velocities[106], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.ds_block_13.pw_bn_beta,  grad_b13_pw_beta,  velocities[107], Float64(learning_rate), Float64(momentum))

    # FC (base = 108):
    sgd_momentum_update_inplace(model.fc_weights, grad_fc_w, velocities[108], Float64(learning_rate), Float64(momentum))
    sgd_momentum_update_inplace(model.fc_bias,    grad_fc_b, velocities[109], Float64(learning_rate), Float64(momentum))
