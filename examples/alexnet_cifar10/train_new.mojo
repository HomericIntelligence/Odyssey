...
Usage:
    mojo run examples/alexnet_cifar10/train_new.mojo --epochs 100 --batch-size 128 --lr 0.01 --momentum 0.9
...
References:
    - Original implementation: examples/alexnet_cifar10/train.mojo (551 lines)
