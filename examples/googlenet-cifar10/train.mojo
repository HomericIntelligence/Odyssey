...
fn train_epoch(
    ...
    print("Epoch " + String(epoch + 1) + "/" + String(200))
    ...
    for batch_idx in range(num_batches):
        ...
        var batch_loss = loss._data.bitcast[Float32]()[0]
