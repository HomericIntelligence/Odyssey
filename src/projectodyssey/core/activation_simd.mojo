...
Usage:
    from odyssey.core.activation_simd import relu_simd, elu_simd, selu_simd, swish_simd
...
from odyssey.core.activation_constants import SIGMOID_CLIP_THRESHOLD
...
def leaky_relu_simd(
    ...
    Examples:
        ...
        ```
    """
    from odyssey.core.activation import leaky_relu
...
def relu6_simd(tensor: AnyTensor) raises -> AnyTensor:
    ...
    Examples:
        ...
        ```
    """
    from odyssey.core.activation import relu6
...
def _elu_simd_float32(tensor: AnyTensor, mut result: AnyTensor, alpha: Float32):
    ...
    from odyssey.core.activation_ops import exp_scalar_f32
...
def _elu_simd_float64(tensor: AnyTensor, mut result: AnyTensor, alpha: Float64):
    ...
    from odyssey.core.activation_ops import exp_scalar_f64
...
def selu_simd(
    ...
    Examples:
        ...
        ```
    """
    from odyssey.core.activation import selu
...
def swish_simd(tensor: AnyTensor) raises -> AnyTensor:
    ...
    Examples:
        ...
        ```
    """
    from odyssey.core.activation import swish
