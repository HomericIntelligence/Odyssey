...
**Location**: `src/odyssey/core/matrix.mojo`
...
**Tests**: `tests/odyssey/core/test_matrix.mojo`

**Exports**: Yes, via `src/odyssey/core/__init__.mojo`
...
**Location**: `src/odyssey/core/shape.mojo`
...
**Tests**: `tests/odyssey/core/test_shape.mojo`
...
**Exports**: Yes, all functions exported via `src/odyssey/core/__init__.mojo`
...
**Location**: `src/odyssey/core/elementwise.mojo`
...
**Tests**: `tests/odyssey/core/test_elementwise.mojo`
...
**Location**: `src/odyssey/core/reduction.mojo`
...
**Tests**: `tests/odyssey/core/test_reduction.mojo`
...
**Location**: `src/odyssey/tensor/any_tensor.mojo` + `src/odyssey/training/trainer_interface.mojo`
...
**DataLoader Integration**: `src/odyssey/training/trainer_interface.mojo:381`
...
**Tests**: `tests/odyssey/core/test_slicing.mojo`
...
The `AnyTensor` class (`src/odyssey/tensor/any_tensor.mojo:1-40`) includes a comprehensive
...
**File**: `src/odyssey/core/__init__.mojo`
...
```mojo
from odyssey.core import split, tile, repeat, broadcast_to, permute
from odyssey.core import exp, log, sqrt, sin, cos
from odyssey.core import matmul, transpose, dot, outer
from odyssey.core import variance, std_reduce, median, percentile
...
| ----------- | -------- | ---------- |
| **Implement or document status of matrix operations** | ✅ COMPLETE | `src/odyssey/core/matrix.mojo`: 7 operations documented with test files |
| **Implement or document status of shape manipulation** | ✅ COMPLETE | `src/odyssey/core/shape.mojo`: 14 operations documented with test files |
| **Implement or document status of element-wise math** | ✅ COMPLETE | `src/odyssey/core/elementwise.mojo`: 11 operations documented with test files |
| **Implement or document status of statistical operations** | ✅ COMPLETE | `src/odyssey/core/reduction.mojo`: 4 operations documented with backward passes |
...
`shared/` to `src/odyssey/` prior to this issue's scope.
...
- Matrix ops: `src/odyssey/core/matrix.mojo`
- Shape manipulation: `src/odyssey/core/shape.mojo`
- Element-wise math: `src/odyssey/core/elementwise.mojo`
- Statistical ops: `src/odyssey/core/reduction.mojo`
- Slicing: `src/odyssey/tensor/any_tensor.mojo`
