...
- tests/odyssey/data/datasets/test_base_dataset.mojo:25
- tests/odyssey/data/datasets/test_tensor_dataset.mojo:32
- tests/odyssey/data/loaders/test_base_loader.mojo:20
- tests/odyssey/data/transforms/test_pipeline.mojo:25 & 35
- src/odyssey/data/transforms.mojo:621 & 400
...
**File**: tests/odyssey/data/datasets/test_base_dataset.mojo
...
### Affected Files (1 file: src/odyssey/data/transforms.mojo)
...
**File**: src/odyssey/data/transforms.mojo, line 523
...
**File**: tests/odyssey/data/transforms/test_augmentations.mojo
...
from odyssey.core.any_tensor import AnyTensor
```text
...
# To:
from odyssey.core.any_tensor import AnyTensor, Tensor
```text

**Option B**: Replace all Tensor usages (if Tensor is not available)

```bash
# Run in tests/odyssey/data/transforms/ directory
...
### Affected File (1 file: src/odyssey/data/transforms.mojo)
...
**File**: src/odyssey/data/transforms.mojo, line 458
...
**File**: tests/odyssey/data/datasets/test_base_dataset.mojo, line 15
...
1. tests/odyssey/data/datasets/test_base_dataset.mojo (line 25)
2. tests/odyssey/data/datasets/test_tensor_dataset.mojo (line 32)
3. tests/odyssey/data/loaders/test_base_loader.mojo (line 20)
4. tests/odyssey/data/transforms/test_pipeline.mojo (lines 25, 35)
...
```bash
# Add ^ to return statements in src/odyssey/data/transforms.mojo:
...
```bash
# Edit tests/odyssey/data/transforms/test_augmentations.mojo:
...
```bash
# Edit src/odyssey/data/transforms.mojo, line 458:
