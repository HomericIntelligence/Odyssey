...
```mojo
from odyssey.core import randn, matmul
...
```mojo
from odyssey.core import randn, dot
...
```mojo
from odyssey.core import randn, outer
...
```mojo
from odyssey.core import randn, eye
...
```mojo
from odyssey.core import randn, solve
